<?php
    ...
    if($estado="Realizando"){
        ...
        try {
            ...
            $mail->Body = "<table><thead><tr styles='border: 1px solid black;'><th>ID</th><th>TAREA</th><th>STATUS</th></tr></thead><tr styles='border: 1px solid black;'><td> ".$idTareas." </td><td> ".$info_tarea.' </td> <td> Finalizada </td></tr></table>';
