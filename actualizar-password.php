                    ...
                    <?php 
                        ...
                        if (isset($_POST['actPasword'])) {
                            if ($_POST['pasword'] ) {
                                ...
                                $core = $_POST['email'];
                                $hash = md5($paswo);
                                $conenctaBD->query("UPDATE registro SET contrasena = '$hash' WHERE id_regitro = $idr") or die(mysqli_errno($conenctaBD));
                                $respueta = "Contraseña actualizado";
